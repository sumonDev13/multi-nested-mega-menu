  ...
  return (
    <div className="relative mt-[12px]">
      ...
      <div className="relative custom-container w-full top-0 z-10">
        <ul className="w-full absolute top-[-381px] max-w-[230px] bg-background p-[6px] flex flex-col gap-y-3">
          ...
          {menus.map((menu, index) => (
            ...
            >
              ...
              {activeSubMenu === index && menu.dropdown.length > 0 && (
                <ul className="w-full absolute top-0 left-[95%] bottom-0 max-w-[230px] bg-background p-[6px] flex flex-col gap-y-3 duration-200">
                    ...
                    >
                      ...
                      {subSubMenu === subIndex &&
                        submenu.dropdown.length > 0 && (
                          <ul className="w-full absolute top-0 bottom-0 sm:max-w-[230px] bg-background p-[6px] flex flex-col gap-y-3 duration-200  left-[95%] ">
